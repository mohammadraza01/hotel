...
<body>
	...
	<div class="banner-top ">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				...
				<li style="margin-left: 100x;" ><button type="button" style="background-color:black" class ="btn btn-lg"><a style="background-Color :gray; text-transform: capitalize;  " href="register.php">REGISTER</a></button></li>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">mmraza01@gmail.com</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9723389731</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">raza<span>mr7</span>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">raza</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About Our raza</h3>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+91 9723389731</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:mmraza01@gmail.com">mmraza01@gmail.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> tapovan circle</p>
				...
				<!-- <iframe src="" ></iframe> -->
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3669.3930239269826!2d72.6144436!3d23.119305199999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e822a02d89c93%3A0x8130dd61df7c1cca!2sTapovan%20Cir%2C%20Ahmedabad%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1706785765414!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
	...
	<!-- /contact -->
	<div class="copy">
		<p>© 2017 raza . All Rights Reserved | Design by <a href="index.php">raza</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
